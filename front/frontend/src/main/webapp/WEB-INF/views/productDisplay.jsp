...
<!-- Page Content -->
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <p class="lead">WATCHES</p>
                <div class="list-group">
                    <a href="categoryDropdown/101" class="list-group-item">NEW ARRIVAL</a>
                    <a href="categoryDropdown/102" class="list-group-item">FASTRACK WATCH</a>
                    <a href="categoryDropdown/103" class="list-group-item">TITAN WATCH</a>
                    <a href="categoryDropdown/104" class="list-group-item">TIMEX</a>
...
<a href="categoryback"><button type="button" class="btn btn-primary" >back to categories</button></a>
 ...
 cartApp.controller("addToCartCtrl", function ($scope, $http){
     ...
     $scope.removeItemFromCart = function (id) {
         $http.put('http://localhost:8086/frontendproject1/removeItem/'+id).success(function (data) {
     ...
     $scope.addItemToCart = function (id) {
         $http.put('http://localhost:8086/frontendproject1/categoryDropdown/productDisplay/usercart/cart/addItem/'+id).success(function (data) {
     ...
     $scope.refreshCartItems = function () {
         $http.get('http://localhost:8086/frontendproject1/refreshCart/'+$scope.cartId).success(function (data) {
            $scope.cart=data;
         });
     };
     ...
     $scope.clearCartItems = function () {
     	$http['delete']('http://localhost:8086/frontendproject1/clearCartItems/'+$scope.cartId).success(function (data)
     			{$scope.refreshCartItems()
     		});
     };
 });
